...
public class Mapreader : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        trigo = new float[12, 12, 2]; //TAULUKKO 11 X 11, RUUTUA, ETÄISYYS JA SUUNTA
        local = new int[12, 12, 3]; //TAULUKKO 11 X 11, RUUTUA, kohteen sijainti 0 ja laji 1, ja 2 tarvittaessa
